...
$checkpoint = Get-Content -Raw (Join-Path $RepositoryRoot "docs\G1_02_ROUND_1B_PAIR_FORMATION.md")
Assert-Condition ($checkpoint -match "NOT SATURATED") "Round 1B saturation decision must be NOT SATURATED"
[PSCustomObject]@{LightReviews=2; FullTextBlocked=2; PairFormationSaturation="NOT SATURATED"; Result="PASS"} | Format-List
