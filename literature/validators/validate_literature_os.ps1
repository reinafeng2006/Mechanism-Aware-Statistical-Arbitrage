...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01–G2-03 APPROVED / FROZEN.*G2-04 PROPOSED / AWAITING RESEARCHER APPROVAL.*DESIGN ONLY.*G2-05 NOT AUTHORIZED') "G2 must stop at the G2-04 approval checkpoint."
...
[PSCustomObject]@{
    ...
    G2Status = 'G204_PROPOSED_AWAITING_APPROVAL_G205_NOT_AUTHORIZED'
    Result = 'PASS'
} | Format-List
