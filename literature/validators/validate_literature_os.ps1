...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01 PROPOSED.*AWAITING RESEARCHER APPROVAL.*G2-02 NOT AUTHORIZED') "G2 must stop at the G2-01 approval checkpoint."
...
[PSCustomObject]@{
    ...
    G2Status = 'G201_PROPOSED_AWAITING_APPROVAL'
    Result = 'PASS'
} | Format-List
