...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01 APPROVED / FROZEN.*G2-02 PROPOSED / AWAITING RESEARCHER APPROVAL.*DESIGN ONLY.*G2-03 NOT AUTHORIZED') "G2 must stop at the G2-02 approval checkpoint."
...
[PSCustomObject]@{
    ...
    G2Status = 'G202_PROPOSED_AWAITING_APPROVAL_G203_NOT_AUTHORIZED'
    Result = 'PASS'
} | Format-List
