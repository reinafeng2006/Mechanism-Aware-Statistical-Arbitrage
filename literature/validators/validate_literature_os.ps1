...
Assert-Condition ($gatesText -match 'G3A PIT Data / Provider Feasibility Audit.*APPROVED / COMPLETE / FEASIBILITY NOT DESIRABILITY') "G3A must remain approved, complete and feasibility-only."
