...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01 APPROVED / FROZEN.*DESIGN ONLY.*G2-02 NOT AUTHORIZED') "G2 must stop after the frozen G2-01 decision."
...
[PSCustomObject]@{
    ...
    G2Status = 'G201_APPROVED_FROZEN_G202_NOT_AUTHORIZED'
    Result = 'PASS'
} | Format-List
