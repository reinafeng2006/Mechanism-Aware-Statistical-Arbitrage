...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01 through G2-06 APPROVED / FROZEN; DESIGN ONLY; G2-07 NOT AUTHORIZED') "G2 must stop after the G2-06 freeze and before G2-07."
...
[PSCustomObject]@{
    ...
    G2Status = 'G206_APPROVED_FROZEN_G207_NOT_AUTHORIZED'
    Result = 'PASS'
} | Format-List
