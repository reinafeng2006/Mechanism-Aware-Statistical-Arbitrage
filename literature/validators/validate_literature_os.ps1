...
Assert-Condition ($gatesText -match 'G2 Measurement.*G2-01 and G2-02 APPROVED / FROZEN.*DESIGN ONLY.*G2-03 NOT AUTHORIZED') "G2 must stop after the frozen G2-02 decision."
...
[PSCustomObject]@{
    ...
    G2Status = 'G202_APPROVED_FROZEN_G203_NOT_AUTHORIZED'
    Result = 'PASS'
} | Format-List
