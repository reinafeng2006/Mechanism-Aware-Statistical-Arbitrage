...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-07 APPROVED / FROZEN')) -and ($measurement.Contains('G2-08 is not authorized'))) 'G2-07 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G207_FROZEN_G208_NOT_AUTHORIZED'
