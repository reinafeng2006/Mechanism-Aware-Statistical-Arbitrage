...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 and G2-02 APPROVED / FROZEN')) -and ($measurement.Contains('G2-03 is not authorized'))) 'G2-02 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G202_FROZEN_G203_NOT_AUTHORIZED'
