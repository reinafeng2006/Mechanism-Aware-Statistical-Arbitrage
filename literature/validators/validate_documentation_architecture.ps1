...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-10 APPROVED / FROZEN')) -and ($measurement.Contains('G2-11 is not authorized'))) 'G2-10 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G210_FROZEN_G211_NOT_AUTHORIZED'
