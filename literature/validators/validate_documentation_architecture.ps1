...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-03 APPROVED / FROZEN')) -and ($measurement.Contains('G2-04 is not authorized'))) 'G2-03 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G203_FROZEN_G204_NOT_AUTHORIZED'
