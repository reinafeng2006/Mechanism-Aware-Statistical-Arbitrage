...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-11 APPROVED / FROZEN')) -and ($measurement.Contains('G2-12 PROPOSED / AWAITING RESEARCHER APPROVAL')) -and ($measurement.Contains('G3A/G3B remain locked'))) 'G2-12 proposal or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G211_FROZEN_G212_PROPOSED_G3A_G3B_LOCKED'
