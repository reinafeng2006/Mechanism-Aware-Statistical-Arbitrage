...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-11 APPROVED / FROZEN')) -and ($measurement.Contains('G3 remains locked'))) 'G2-11 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G211_FROZEN_PRE_G3_NOT_AUTHORIZED_G3_LOCKED'
