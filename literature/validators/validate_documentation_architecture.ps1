...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 and G2-02 APPROVED / FROZEN')) -and ($measurement.Contains('G2-03 PROPOSED / AWAITING RESEARCHER APPROVAL')) -and ($measurement.Contains('G2-04 is not authorized'))) 'G2-03 proposal or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G203_PROPOSED_G204_NOT_AUTHORIZED'
