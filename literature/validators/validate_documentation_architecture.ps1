...
Assert-Doc (($measurement.Contains('G2 ACTIVE — DESIGN ONLY')) -and ($measurement.Contains('G2-01 through G2-08 APPROVED / FROZEN')) -and ($measurement.Contains('G2-09 is not authorized'))) 'G2-08 freeze or design-only boundary missing.'
...
[pscustomobject]@{
    ...
    G1Status = 'FROZEN'
    G2Status = 'ACTIVE_DESIGN_ONLY_G208_FROZEN_G209_NOT_AUTHORIZED'
