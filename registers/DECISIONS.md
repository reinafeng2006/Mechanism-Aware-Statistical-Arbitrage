...
| G2-01 | Freeze the combined joint-conditional-distribution and bidirectional conditional-response semantic framework, four-object distinction, PIT and anti-circularity boundaries | PROPOSED | AWAITING RESEARCHER APPROVAL; no estimator/representation selected; G2-02 unauthorized; see docs/stages/G2/G2_01_RELATIONSHIP_SEMANTICS_PROPOSAL.md |
