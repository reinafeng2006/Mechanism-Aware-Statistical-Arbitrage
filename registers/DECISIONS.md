...
| G1-04 | Freeze permitted downstream use and authorize G2 handoff for continuous/uncertain sequential belief-updating rather than a mandatory M0–M3 classifier | APPROVED | Researcher approval, 2026-09-04; see docs/G1_04_EVIDENCE_FREEZE.md and docs/G2_HANDOFF_CONTRACT.md |
| G2-00 | Initialize the dependency-ordered G2 Measurement & Timing decision structure without selecting or operationalizing any candidate | APPROVED | Researcher authorization, 2026-09-04; initialization only; see docs/G2_INITIAL_DESIGN_CHECKPOINT.md |
...
| G2-01 | Freeze the combined joint-conditional-distribution and bidirectional conditional-response semantic framework, four-object distinction, PIT and anti-circularity boundaries | PROPOSED | AWAITING RESEARCHER APPROVAL; no estimator/representation selected; G2-02 unauthorized; see docs/G2_01_RELATIONSHIP_SEMANTICS_PROPOSAL.md |
