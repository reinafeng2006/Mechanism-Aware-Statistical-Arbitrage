...
| G2-02 | Freeze P0/P1 pair-information architecture, five-family separation, slow P1 context, fair comparison and incremental normal-relationship-level value boundary | APPROVED | Researcher approval, 2026-09-04; downstream return prediction/PnL alone insufficient; no representation/model/metric selected; G2-03 unauthorized; see docs/decisions/G2_02_PAIR_INFORMATION_ARCHITECTURE.md |
