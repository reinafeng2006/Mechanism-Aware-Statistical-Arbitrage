...
if($a.pv_m2_additions_ordered.Count -ne 9){throw 'MP1-I-A base descendant shape mismatch.'}
if($e.a6.field_closure -eq 'V1-EXECUTABLE-CLOSURE-EV-A-V1-FD-A-ER-A-1.0'){
  if($e.a6.pv_m2_addition_count -ne 15){throw 'EV-A-V1 three-state PV-M2 shape mismatch.'}
} elseif($e.a6.pv_m2_addition_count -ne 9){throw 'PV-M2 descendant shape mismatch.'}
