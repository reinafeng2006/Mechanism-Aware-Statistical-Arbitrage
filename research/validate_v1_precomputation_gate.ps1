...
$finalHeldout = (
    ...
    $action.action.execution_state -in @('HELDOUT_RUNNER_PREPARATION_AUTHORIZED_ACCESS_NOT_YET_OPENED','HELDOUT_R4_RESUME_READY_AT_2025','HELDOUT_R4_CHECKPOINTED_RESUME_READY_AT_2025') -and
