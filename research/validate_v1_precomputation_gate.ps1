...
$h126Amendment = (
    ...
    $action.action.execution_state -in @('A1_H126_AMENDMENT_QUALIFIED_PENDING_PUBLICATION','AUTHORIZED_A1_H126_PRE_HELD_OUT_EXECUTION','READY_FOR_EXTERNAL_SYNTHESIS_EXECUTION') -and
    $action.action.held_out_access -eq 'SEALED_DENIED'
)
