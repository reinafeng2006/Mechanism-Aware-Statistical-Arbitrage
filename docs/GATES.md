...
| G1 Literature & Mechanism Evidence | Determine what existing evidence says deserves measurement and why through nested G1-01–G1-04 | Approved design/discovery; full-text claim ledger; four synthesis maps; evidence freeze/handoff | **G1-02 COMPLETE — G1-03 LOCKED PENDING APPROVAL** |
