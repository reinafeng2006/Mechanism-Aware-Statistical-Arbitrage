...
Opposite-direction movement is not automatically abnormal or M3. The G2 abstraction is observed joint response versus expected conditional joint response; only their departure is candidate abnormality. See D-017 in `G2_NORMAL_RELATIONSHIP_REQUIREMENT.md`.
