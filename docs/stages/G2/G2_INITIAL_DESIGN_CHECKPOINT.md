...
Status: **ACTIVE — INITIALIZATION / DESIGN ONLY; G2-01/G2-02 FROZEN; G2-03 NOT AUTHORIZED**
...
G2-01 and G2-02 are **APPROVED / FROZEN**. Rows 3–11 remain **UNRESOLVED — RESEARCHER DECISION REQUIRED BEFORE MEASUREMENT FREEZE**. Candidate families are preserved for comparison, not selected.
