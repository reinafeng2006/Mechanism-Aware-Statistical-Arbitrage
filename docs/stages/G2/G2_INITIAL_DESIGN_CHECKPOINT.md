...
Status: **ACTIVE — DESIGN ONLY; G2-01–G2-11 FROZEN; PRE-G3 READINESS NOT YET AUTHORIZED; G3 LOCKED**
...
| 6 | M1 under-response — **APPROVED / FROZEN SEMANTICS** | Five-part decomposition; orientation and weak-direction/U rule; three information sets; competing UR0/UR1/UR2 candidates; five-time lineage; feasibility inheritance. | Response gap is not M1 identification/probability; future catch-up validation-only; no candidate or formula selected. | CL-M1-001/003; G2-01/G2-03/G2-04/G2-05; G2-06 |
