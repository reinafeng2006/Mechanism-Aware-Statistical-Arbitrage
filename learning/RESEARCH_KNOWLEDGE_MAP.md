...
**G2-03 proposal:** **PROPOSED — AWAITING RESEARCHER APPROVAL; G2-04 NOT AUTHORIZED.** N0 and N1 target the same G2-01 normal-relationship object. N0 is the industry-structured/strongly pooled simpler benchmark without requiring identical pair parameters; N1 permits substantially greater pair-specific PIT-history influence. Pooling strength, not semantic normality, differs. N2 remains **ILLUSTRATIVE / UNAUTHORIZED** pending a specific unresolved N0 heterogeneity, N1 uncertainty/instability, sparse-history or relationship-level calibration/generalization problem. Pooling strength may differ across industries; no Industry Homogeneity Score is defined.
