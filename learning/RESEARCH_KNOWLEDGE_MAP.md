...
**G2-02 proposal:** **PROPOSED — AWAITING RESEARCHER APPROVAL; G2-03 NOT AUTHORIZED.** P0 is the simpler PIT market/statistical relationship-information architecture with raw joint/co-movement, factor/exposure, conditional/residual, stability/breakdown and signed/asymmetric/state-dependent families kept distinct. P1 is unchanged P0 plus a separate secondary Economic/Company Relationship layer. Slow P1 information normally remains cached relationship context. P1 would require incremental relationship-level value under the same protocol; no representation, metric or winner is selected.
