...
**G2-10:** **APPROVED / FROZEN — 2026-09-07; G2-11 NOT AUTHORIZED.** U is a legitimate dynamic epistemic state under current PIT information, separate from Abstain as an action and No Trade as a possible outcome. Five overlapping uncertainty sources and U0–U4 candidate representation families are preserved without selection. `Not yet known` is distinct from `currently non-identifiable`; no probability simplex, threshold, transition or decision model is chosen.
