...
$required = @(
  ...
  'learning/walkthroughs/pair_validity.md','learning/walkthroughs/residual_and_fdr.md','learning/dashboard/index.html','learning/dashboard/README.md','learning/RESEARCH_KNOWLEDGE_MAP.md')
...
foreach ($stage in @('Company Representation','Pair Formation','Normal Pair Relationship','Abnormal Relative State','Mechanism Identification','Resolution Prediction','Trade / No Trade')) { if ($dashboard -notmatch $stage) { throw "Missing pipeline stage: $stage" } }
