...
$required = @(
  ...
  'learning/cards/m1_information_diffusion.md','learning/cards/event_time_provenance.md','learning/cards/m2_pressure_identification.md','learning/paper-guides/M1-001.md','learning/paper-guides/M2-001.md','learning/paper-guides/M2-002.md','learning/paper-guides/M2-003.md','learning/paper-guides/M2-005.md','learning/paper-guides/B4-004.md','learning/walkthroughs/pair_validity.md','learning/walkthroughs/residual_and_fdr.md','learning/walkthroughs/m1_attribution_boundary.md','learning/dashboard/index.html','learning/dashboard/README.md','learning/RESEARCH_KNOWLEDGE_MAP.md')
